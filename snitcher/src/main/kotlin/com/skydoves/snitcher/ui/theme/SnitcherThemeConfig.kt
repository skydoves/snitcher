 ...
 * `theme` parameter of [Snitcher.install], and the built-in [ExceptionTraceActivity] and every
 * screen wrapped in [SnitcherTheme] will be styled with it.
 *
 * ```kotlin
 * Snitcher.install(
 *   application = this,
...
public data class SnitcherThemeConfig(
  ...
  val shapes: SnitcherShapes = SnitcherShapes(),
)
